    ...
    <div className="max-w-400 mx-auto p-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Note: Name, Email, and Employee ID are system-generated and cannot be
          modified.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                disabled={
                  (profileData.shiftTiming && !isEditingProfile)
                }
                className="w-full border border-gray-300 rounded-lg px-3 py-2 disabled:bg-gray-100"
              >
          ...
          {(isEditingProfile || isEditingAddress) && (
            <div className="mt-6">
              <button
                type="submit"
                disabled={loading}
                className="px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white flex items-center gap-2 disabled:opacity-70"
              >
