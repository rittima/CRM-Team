       ...
       <div className="bg-gray-100 rounded-lg shadow-sm p-6 space-y-4">
        ...
        <div className="bg-gray-100 rounded-lg shadow-sm p-6 space-y-4 mt-6">
          ...
          {[
            ...
            { label: "Housing Allowance", amount: salary.housingAllowance, type: "positive" },
            { label: "Transport Allowance", amount: salary.transportAllowance, type: "positive" },
            { label: "Medical Allowance", amount: salary.medicalAllowance, type: "positive" },
            { label: "Performance Bonus", amount: salary.performanceBonus, type: "positive" },
            { label: "Income Tax", amount: salary.incomeTax, type: "negative" },
            { label: "Social Security", amount: salary.socialSecurity, type: "negative" },
            { label: "Health Insurance", amount: salary.healthInsurance, type: "negative" },
          ].map((item, i) => (
            <div key={i} className="flex justify-between text-sm text-gray-700">
              <span>{item.label}</span>
              <span
